...
- Pituitary adenoma can arise from any type of cell of the anterior pituitary
...
- Function:
  ...
  - Hyper-secretion
  - Hypo-function (hypopituitarism) - due to compression of other cell types

- Various types


  | Anterior Pituitary Cell Type  | Clinical Syndrome                                            |
  | ----------------------------- | ------------------------------------------------------------ |
  | Gonadotroph                   | Clinically non-functioning, very rarely causes symptoms due to hormonal hypersecretion |
  | Thyrotroph (TSH-secreting)    | Hyperthyroidism                                              |
  | Corticotroph (ACTH-secreting) | Cushing's disease                                            |
  | Lactotroph (Prolactinoma)     | Hyperprolactinemia                                           |
  | Somatotroph (GH-secreting)    | Acromegaly                                                   |

**Presentation**

Typically present in one or more of the following ways

- With neurological symptoms: visual impairment, diplopia, headache

- Incidental finding on MRI performed for some other reason
- With hormonal abnormalities

**Evaluation of a Pituitary Mass**

- First-line (basal hormonal testing)
  - 8 am cortisol, ACTH
  - FT4 TSH
  - Prolactin
  - Insulin-like growth factor-1 (IGF-1)
  - Testosterone / Estradiol (E2), FSH and LH

- Additional testing for excess production
  - Cushing's disease: dexamethasone suppression test, 24 Hr urine free cortisol
  - Acromegaly: OGTT GH suppression testing
  - TSHoma: TRH stimulation test, octreotide suppression test
- Hormonal deficiency (macroadenoma)
  - Adrenal insufficiency: synthetic ACTH (Synacthen) stimulation test
...
- Use surgical resection for
  ...
  - **Secretory** adenoma with the exception of prolactinoma (primarily treated with dopamine agonist-carbergoline / bromocriptine)
  - **Compression** on optic chiasm - complete neuro-opthalmologic evaluation
  - **Hypopituitarism** - relative indication: function may not improve

- Hormonal replacement in hypopituitarism

  - Hydrocortisone 15-20 mg/day in 2 - 3 divided doses, commonly:
    - 10 mg on waking up 
    - 5 mg in the afternoon
  - Levothyroxine for hypothyroidism
  - Testosterone / estradiol for hypogonadism

**Management**

- For hormone secreting tumor: Trans-sphenidal surgery is the preferred surgical treatment these days. 
...
- Growth hormone-secreting somatotroph adenoma
  - Typically macroadenoma (&geq;1cm)
- Unregulated GH secretion stimulates hepatic secretion of insulin-like growth factor-1 (IGF-1)
  - Causes most of the clinical manifestations of acromegaly

**Presentation:** Intermittent Headache

**Clinical Features**

| Category                | Specific Signs                                               |
| ----------------------- | ------------------------------------------------------------ |
| Local tumour effects    | Headache, VF defects                                         |
| Somatic                 | Enlargement of aural (hands, feet), jaw (prognathism), frontal bones, carpal tunnel syndrome, arthralgia and arthritis. |
| Skin and GI             | Skin tags, oily texture, colon polyps                        |
| Cardiovascular          | LVH, cardiomyopathy, hypertension, CCF                       |
| Pulmonary               | Sleep apnea (central and obstructive)                        |
| Visceromegaly           | Tongue, thyroid gland, liver                                 |
| Endocrine and metabolic | Hypogonadism, insulin resistance, hypertriglyceridemia       |

**Diagnosis**

Biochemical. 

- Screen: Look for elevated IGF-1 concentration
- Results: Inadequate suppression of GH after glucose load (75g - OGTT)
  - GH falls to <1mg/ml within 2 hours in normal subjects
  - Radiological localisation by MRI pituitary

***Case: 27 year old lady, single, no significant PMHx; MRI Brain was done for intermittent headache - sellar-suprasellar mass 3.1 cm, abutting the optic chiasm. Also reports irregular periods x 1 year, increasing finger and feet size.***

Which is the most appropriate test to do next?

- Serum growth hormone releasing hormone (GHRH)
- Serum growth hormone (GH)
- Serum insulin-like growth factor (IGF-1)
- 75-g oral glucose tolerance test for GH suppression

***Answer:*** **Screening with IGF-1 due to suspicion of acromegaly** i..e growth hormone secreting pituitary tumour. This is preferred to direct measurement of GH because IGF-1 has a longer half-life and is a more stable. GH act on liver to secrete IGF-1. GH is hard to measure at random. One may then conduct OGTT for GH suppression for confirmation. 

### Hypopituitarism

- **Pituitary adenoma**
- **Neoplastic**: craniopharyngioma, Rathke's cleft cyst, metastases e.g. breast cancer
- **Post-treatment**: surgery (pituitary), RT (head/neck)
- **Infiltrative / Inflammatory**: autoimmune, hemochromatosis, Langerhans cell histiocytosis
- **Infectious**: TB
- **Vascular**: pituitary tumour apoplexy, Sheehan's syndrome
- **Traumatic**: head injury
- **Drugs**: immunotherapy (checkpoint inhibitors), opiates

**Management**

- Central diabetes insipidus
  - ADH deficiency may occur if posterior pituitary gland / pituitary stalk is involved in the disease process
  - Symptoms: marked polyuria and thirst
  - Treatment: desmopressin (DDAVP - intranasal, oral)
...
| Category                           | TSH     | FT4     |
| ---------------------------------- | ------- | ------- |
| Primary hypothyroidism             | &uarr;  | &darr;  |
| Subclinical hypothyroidism         | &uarr;  | &lrarr; |
| Secondary (central) hypothyroidism | &lrarr; | &darr;  |

#### Compensated hypothyroidism (organs working)

- 5 - 8x more common in women than in men
- Most common cause of hypothyroidism
  - Chronic autoimmune (Hashimoto's) thyroiditis (>95%)
  - Which is caused by cell- and antibody-mediated destruction of thyroid tissue
- Highly variable clinical manifestations, depending upon the age and duration and severity of TH deficiency
...
| --------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| Slowing of metabolic processes    | Fatigue and weakness, cold intolerance, dyspnea on exertion, weight gain, cognitive dysfunction, constipation | Slow movement and slow speech, delayed relaxation of tendon reflexes, bradycardia |
| Accumulation of matrix substances | Dry skin, hoarseness, edema                                  | Coarse skin, puffy facies and loss of eyebrows, periorbital edema, enlargement of the tongue |
| Other                             | Myalgia and parenthesis, depression, menorrhagia, arthralgia | Diastolic hypertension, pleural and pericardial effusions, ascites |

**Diagnosis**

- Biochemical
- Need to rule out hypothyroidism in patients with statin-induced rhabdomyolysis

#### Decompensated hypothyroidism (organs failing)

- Previously known as mxyedema coma, but this is a misnomer - rarely oedema, rarely coma; better thought of as decompensated hypothyroidism
...
People with hypothyroidism may be pushed into physiologic stress e.g. sepsis, cold exposure, surgery, burns, trauma, medication non-adherence.
...
- Uncommon
- TSH is inappropriately normal or low
  - Does not increase appropriately as T4 secretion falls
...
- TSH / T4 / Cortisol to determine type
  - Extend of reduction in FT4 FT3 does not differentiate between a decompensated state of hypothyroidism, vs compensated. This is also similar to thyrotoxicosis, vs thyroidstorm. 
- Renal panel: for hyponatremia
- FBC, blood cultures, inflammatory markers
  - FBC for leukopenia
  - Blood cultures and inflammatory markers for 
- ECG - bradycardia, prolongation of QTc, small voltage complexes
- Hypoglycemia
...
- Precipitant: infection is common, need to search and treat it. 
...
- Iodide
  - Works by the wolff-chaikoff effect
    - We would assume that if we take more iodide thyroid make more hormone
...
- **Supportive therapy**
  - Treat hyperthermia (avoid NSAIDs/salicylates - protein bound, can increase free thyroid hormone levels)
  - Replace volume with strict IO charting
  - Vasopressors
  - Inotropes if the BP is low
  - For rapid AF, rapid ventricular rates, can consider magnesium sulphate
...
- Work up for sepsis, empirical broad spectrum antibiotics
- Identification and immediate discontinuation of causative agent
- Consider G-CSF
...
- Unusual for Graves disease thyroid to be tender. If tender, think of this

Clinical Feature

- Neck pain / discomfort, tender diffuse goitre
- Presumed: viral infection or post viral inflammatory process
- Not a/w thyroid autoimmunity

Prognosis

- Self-limiting 'triphasic' course, monitor for recovery

Symptomatic management

- Pain control: NSAIDs e.g. ibuprofen; or corticosteroids
- Heart rate control: beta-blocker

![Screenshot 2020-06-23 at 11.14.25](/Users/jzan/Library/Application%20Support/typora-user-images/Screenshot%202020-06-23%20at%2011.14.25.png)
...
| Treatment | Mode of Action | Onset of action | Duration of action |
| --------- | -------------- | --------------- | ------------------ |
|           |                |                 |                    |
...
Special interest: technology in management of diabetes in children - Dr Suresh Rama Chandran.
...
Monogenic Diabetes - a single gene is causing the diabetics; Unlike Type II which is polygenic and multi-factorial.

LADA progression to insulin deficiency is slower, and remain insulin dependent for a while.

Peripheral neuropathy - severity indicates damage; initial phase more positive symptoms; 
...
Legacy effect - complications are likely to progress for a few years even if the blood sugar remains in control.
...
| Feature       | Metformin            | Sulfonylurea                 | Thiazolidinedione                      | Meglitinide                                    | DPP-4 Inhibitor                              | SGLT2 Inhibitor                                              | GLP-1 Agonist                | Insulin          |
| ------------- | -------------------- | ---------------------------- | -------------------------------------- | ---------------------------------------------- | -------------------------------------------- | ------------------------------------------------------------ | ---------------------------- | ---------------- |
| Mechanism     | Activates AMP-Kinase | Stimulates insulin secretion | Activates nuclear transcription factor | Like thiazoilidinedion e but more short acting | Inhibits DPP-4, increases incretin secretion | Inhibits SGLT2 in the kidney & Activates GLP-1 receptors, mimics incretin | Overcomes insulin resistance |                  |
...
- Increased risk of ketosis; especially insulin deficient.
- EMPA-REG trial: reduction in death from heart failure with EMPA
...
Basal insulin is not suitable when:

- Low fasting glucose (<8 mmol/L)
- Hba1c > 10%
- Unwilling to titrate insulin

Basal is the DC, we may also consider the AC adjustment. 

How to titrate the basal insulin

| Capillary Blood Glucose (mammal/L) | Dose Adjustment |
| ---------------------------------- | --------------- |
| <4.0                               | -2              |
| 4 - 7                              | No change       |
| 7.1 - 10                           | +2              |
...
Adjust every 3 days based on pre-breakfast reading. 

When to intensify therapy / introduce prandial insulin

- When basal insulin reaches 0.5 to 0.6 units/kg
- When nocturnal hypoglycaemia develops with further increase in basal insulin
- When HbA1c nears target adding a basal insulin will have a high impact; 8 - 8.5

Intensification of insulin regimen

- Options to intensify insulin beyond basal
  - Add a dose of prandial insulin
...
- 0.8 - 1.5 u/kg is the range of insulin requirement; may need 0.5 as basal and the half as bolus



Sliding scale is used in SC or IV

- IV is used in extreme hyperglycaemia - every hour and adjust
- SC insulin needs to be given before the raise in glucose;
...
- &beta;-blocker can be used to control heart rate (reflex tachycardia from &alpha;-blockage)
  ...
  - Note, do NOT start &beta;-blocker until adequate 
  - Mark of adequate alpha blockage: BP < 130/80 

  

### Cushing Syndrome

Differentiate Cushing's syndrome from simple obesity:
...
Low blood pressure and low sodium suggest adrenal insufficiency.
...
| ----------------------- | ------- | ------- |
| Primary hyperthyroidism | &darr;  | &uarr;  |
| Central hyperthyroidism | &lrarr; |         |
...
1. TSH receptor antibody (TRAb) status is helpful

   - Elevated in Graves disease or autoimmune hyperthyroidism
   - Non-ev

   c. No uptake - acute thyroidistis

   d. Hyperfunctioning thyroid
